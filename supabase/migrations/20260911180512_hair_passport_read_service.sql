-- Read-only projection. All authorization and reads retain caller RLS.
create function app_private.hair_evidence_read_model(e public.hair_evidence)
returns jsonb language sql stable strict security invoker set search_path=''
as $$ select jsonb_build_object(
 'id',e.id,'source',e.source_type,
 'observed_at',jsonb_build_object('state',e.observed_at_state,'value',e.observed_at),
 'confidence',jsonb_build_object('state',e.confidence_state,'value',e.confidence),
 'verified_by',e.verified_by,'recorded_by',e.created_by,'recorded_at',e.created_at,
 'relevant_until',e.relevant_until,'location_id',e.location_id,'context',e.context,'supersedes_id',e.supersedes_id); $$;

create function app_private.hair_observation_read_model(o public.hair_observations,e public.hair_evidence)
returns jsonb language sql stable strict security invoker set search_path=''
as $$ select jsonb_build_object(
 'id',o.id,'region_id',o.region_id,'recorded_by',o.created_by,'recorded_at',o.created_at,
 'supersedes_id',o.supersedes_id,'evidence',app_private.hair_evidence_read_model(e),
 'technical_notes',o.technical_notes,'integrity_notes',o.integrity_notes,
 'natural_level',jsonb_build_object('state',o.natural_level_state,'value',o.natural_level),
 'perceived_level',jsonb_build_object('state',o.perceived_level_state,'value',o.perceived_level),
 'grey_ratio',jsonb_build_object('state',o.grey_ratio_state,'value',o.grey_ratio),
 'thickness',jsonb_build_object('state',o.thickness_state,'value',o.thickness),
 'density',jsonb_build_object('state',o.density_state,'value',o.density),
 'porosity',jsonb_build_object('state',o.porosity_state,'value',o.porosity),
 'elasticity',jsonb_build_object('state',o.elasticity_state,'value',o.elasticity),
 'tone',jsonb_build_object('state',o.tone_state,'value',o.tone),
 'cosmetic_color_history',jsonb_build_object('state',o.cosmetic_color_history_state,'value',o.cosmetic_color_history),
 'bleach_history',jsonb_build_object('state',o.bleach_history_state,'value',o.bleach_history),
 'chemical_history',jsonb_build_object('state',o.chemical_history_state,'value',o.chemical_history)); $$;
revoke all on function app_private.hair_evidence_read_model(public.hair_evidence),
 app_private.hair_observation_read_model(public.hair_observations,public.hair_evidence) from public,anon;
grant execute on function app_private.hair_evidence_read_model(public.hair_evidence),
 app_private.hair_observation_read_model(public.hair_observations,public.hair_evidence) to authenticated;

create function public.hair_passport_snapshot(
...
revoke all on function public.hair_passport_snapshot(uuid,uuid,uuid,jsonb,uuid) from public,anon,service_role;
grant execute on function public.hair_passport_snapshot(uuid,uuid,uuid,jsonb,uuid) to authenticated;
