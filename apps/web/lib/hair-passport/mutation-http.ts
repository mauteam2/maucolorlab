...
export async function hairMutationResponse(request: Request, params: Promise<{ clientId: string; regionId?: string }>, operation: HairMutationOperation | "add_observation" | "add_physical_test" | "add_history", execute: MutationExecutor = mutateHairPassport) {
